...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    if (message.author.id != "958517194667479042")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only Gir0fa is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/HjfGcs4WuX), open a Ticket and ask for it!`)
        ]
      });
    try {
